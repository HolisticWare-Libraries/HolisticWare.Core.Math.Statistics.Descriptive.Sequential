...
namespace Core.Math.Statistics.Descriptive.Sequential
{
    ...
    public static partial class Correlation
    {
        ...
        public static double CalculateOptimized(IEnumerable<short> x, IEnumerable<short> y)
        {
            return x.CorrelationOptimized(y);
        }

        public static double CalculateOptimized(IEnumerable<ushort> x, IEnumerable<ushort> y)
        {
            return x.CorrelationOptimized(y);
        }

        public static double CalculateOptimized(IEnumerable<int> x, IEnumerable<int> y)
        {
            return x.CorrelationOptimized(y);
        }

        public static double CalculateOptimized(IEnumerable<uint> x, IEnumerable<uint> y)
        {
            return x.CorrelationOptimized(y);
        }

        public static double CalculateOptimized(IEnumerable<long> x, IEnumerable<long> y)
        {
            return x.CorrelationOptimized(y);
        }

        public static double CalculateOptimized(IEnumerable<ulong> x, IEnumerable<ulong> y)
        {
            return x.CorrelationOptimized(y);
        }

        public static double CalculateOptimized(IEnumerable<float> x, IEnumerable<float> y)
        {
            return x.CorrelationOptimized(y);
        }

        public static double CalculateOptimized(IEnumerable<double> x, IEnumerable<double> y)
        {
            return x.CorrelationOptimized(y);
        }

        public static decimal CalculateOptimized(IEnumerable<decimal> x, IEnumerable<decimal> y)
        {
            return x.CorrelationOptimized(y);
        }
    }
