...
namespace Core.Math.Statistics.Descriptive
{
    /// <summary>
    /// </summary>
    public static partial class MemoryExtensionsFrequencies
    {
        //==============================================================================================================
        public static 
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<T, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<byte, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<ushort, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<short, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<int, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<uint, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<long, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                    from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<ulong, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                    from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<float, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                    from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<double, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                    from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
                            ...
                            )
        {
            ...
            System.Linq.IOrderedEnumerable<KeyValuePair<decimal, (uint FrequencyAbsolute, double FrequencyRelative, uint FrequencyCumulative)>> frequencies_sorted;
            frequencies_sorted =
                                    from pair in frequencies
                                    orderby pair.Value descending, pair.Key ascending
                                    select pair
